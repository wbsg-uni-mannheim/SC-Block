...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint /ceph/alebrink/contrastive-product-matching/reports/contrastive/walmart-amazon-$AUG$PREBATCH-$LR-$TEMP-$PREEPOCHS-roberta-base/pytorch_model.bin \
    --do_train \
    ...
    --output_dir /ceph/alebrink/contrastive-product-matching/reports/contrastive-ft-siamese/walmart-amazon-$AUG$PREBATCH-$PREAUG$LR-$TEMP-$PREEPOCHS-$EPOCHS-frozen-roberta-base/ \
