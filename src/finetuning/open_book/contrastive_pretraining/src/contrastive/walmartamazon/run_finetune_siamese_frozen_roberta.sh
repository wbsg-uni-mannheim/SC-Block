...
python run_finetune_siamese.py \
    ...
    --output_dir /ceph/alebrink/table-augmentation-framework/contrastive-product-matching/reports/contrastive-ft-siamese/walmart-amazon-clean-$AUG$PREBATCH-$PREAUG$LR-$TEMP-$PREEPOCHS-$EPOCHS-frozen-roberta-base/ \
