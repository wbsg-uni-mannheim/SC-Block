...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint $(pwd)/reports/contrastive/amazongoogle-clean-$PREAUG$BATCH-$LR-$TEMP-roberta-base/pytorch_model.bin \
    --do_train \
    ...
    --output_dir $(pwd)/reports/contrastive-ft-siamese/amazongoogle-clean-$AUG$BATCH-$PREAUG$LR-$TEMP-unfrozen-roberta-base/ \
