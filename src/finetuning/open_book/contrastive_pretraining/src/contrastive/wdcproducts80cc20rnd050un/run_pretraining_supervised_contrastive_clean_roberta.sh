...
python run_pretraining_deepmatcher.py \
	...
	--clean=True \
    --train_file $(pwd)src/finetuning/open_book/contrastive_pretraining/data/processed/wdcproducts80cc20rnd050un/contrastive/wdcproducts80cc20rnd050un-train.pkl.gz \
