...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint $(pwd)/reports/contrastive/computers-$SIZE-$PREAUG$BATCH-$LR-$TEMP-roberta-base/pytorch_model.bin \
    --do_train \
	--frozen=False \
    ...
    --output_dir $(pwd)/reports/contrastive-ft-siamese/computers-$SIZE-$AUG$BATCH-$PREAUG$LR-$TEMP-unfrozen-roberta-base/ \
