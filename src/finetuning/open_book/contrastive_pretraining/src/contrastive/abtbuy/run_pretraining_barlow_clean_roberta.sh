...
python $(pwd)/src/finetuning/open_book/contrastive_pretraining/src/contrastive/run_pretraining_barlow_deepmatcher.py \
    --do_train \
    ...
    --output_dir $(pwd)/reports/contrastive/abtbuy-barlow-$AUG$BATCH-$LR-$TEMP-$EPOCHS-roberta-base/ \
