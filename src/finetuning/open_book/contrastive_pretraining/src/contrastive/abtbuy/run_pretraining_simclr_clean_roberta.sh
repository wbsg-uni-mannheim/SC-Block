...
python $(pwd)/src/finetuning/open_book/contrastive_pretraining/src/contrastive/run_pretraining_simclr_deepmatcher.py \
    --do_train \
    ...
    --output_dir $(pwd)/reports/contrastive/abtbuy-simclr-$AUG$BATCH-$LR-$TEMP-$EPOCHS-roberta-base/ \
	--temperature=$TEMP \
