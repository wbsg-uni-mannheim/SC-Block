...
python run_finetune_siamese.py \
	--model_pretrained_checkpoint $(pwd)/reports/contrastive/wdcproducts80cc20rnd050un-clean-$AUG$PREBATCH-$LR-$TEMP-$PREEPOCHS-roberta-base/pytorch_model.bin \
    --do_train \
    ...
    --output_dir $(pwd)/reports/contrastive-ft-siamese/wdcproducts80cc20rnd050un-clean-$AUG$PREBATCH-$PREAUG$LR-$TEMP-$PREEPOCHS-$EPOCHS-frozen-roberta-base/ \
