...
class SupConBiEncoder(BiEncoder):
    ...
    def encode_entities_and_return_pooled_outputs(self, entity, excluded_attributes=None, without_special_tokens_and_attribute_names=False):
        ...
        inputs, outputs = self.encode_entities(entity, excluded_attributes, without_special_tokens_and_attribute_names=without_special_tokens_and_attribute_names)
